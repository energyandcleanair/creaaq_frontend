...
const envVars = Object.keys(env).reduce((m, key) => {
...
process.env.PORT =
  Number(process.env.VUE_APP_PORT) || Number(process.env.PORT) || 8080
...
module.exports = {
  ...
  configureWebpack: {
    ...
    plugins: [new webpack.DefinePlugin({'process.env': envVars})],
  },
  chainWebpack: (config) => {
